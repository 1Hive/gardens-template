...
contract GardensTemplate is BaseTemplate {
    ...
    */
      ...
      bytes32 private constant REDEMPTIONS_APP_ID = keccak256(abi.encodePacked(apmNamehash("1hive"), keccak256("redemptions")));
      ...
      bytes32 private constant BANCOR_FORMULA_ID = keccak256(abi.encodePacked(apmNamehash("1hive"), keccak256("bancor-formula")));
      bytes32 private constant PRESALE_ID = keccak256(abi.encodePacked(apmNamehash("1hive"), keccak256("presale")));
      bytes32 private constant MARKET_MAKER_ID = keccak256(abi.encodePacked(apmNamehash("1hive"), keccak256("bancor-market-maker")));
      bytes32 private constant MARKETPLACE_CONTROLLER_ID = keccak256(abi.encodePacked(apmNamehash("1hive"), keccak256("marketplace-controller")));
